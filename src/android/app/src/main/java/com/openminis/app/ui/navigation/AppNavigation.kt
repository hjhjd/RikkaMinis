    ...
    NavHost(
        ...
        composable(Routes.BACKUP) {
            com.openminis.app.ui.settings.BackupSettingsScreen(
                ...
                execPlaneSettings = (context.applicationContext as com.openminis.app.MinisApp).execPlaneSettingsRepository,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.AGENT_NEW) {
            com.openminis.app.ui.agents.AgentEditScreen(
                ...
                skillRepository = skillRepository,
                mcpRepository = mcpRepository,
                memoryFactory = (context.applicationContext as com.openminis.app.MinisApp).agentMemoryRepositoryFactory,
                onBack = { navController.safePopBackStack() },
        ...
        composable(Routes.VCP_INFO) {
            com.openminis.app.ui.settings.VcpInfoCenterScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
