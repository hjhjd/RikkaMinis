...
@Composable
internal fun TypingIndicator(agentName: String? = null) {
    val infiniteTransition = rememberInfiniteTransition(label = "typing")
    val soulMeta by com.openminis.app.agent.SoulStore.cachedMetadata.collectAsState()
    val soulName = agentName?.trim()?.takeIf { it.isNotEmpty() }
        ?: soulMeta.name.trim().ifEmpty { com.openminis.app.agent.SoulMetadata.DEFAULT.name }
