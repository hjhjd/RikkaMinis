...
async def main():
 ...
 runtime=Runtime(a.allow_root,max_exec=a.max_exec,transfer_options={'temp_limit':a.temp_limit_mb*1024*1024,'max_active':a.max_transfers},name=a.name,instruction_set=load_instruction_set(a.instructions),dispatch_handler=load_dispatch_handler(a.dispatch_plugin));runtime.transfers.start();connections=asyncio.Semaphore(a.max_connections)
 try:
